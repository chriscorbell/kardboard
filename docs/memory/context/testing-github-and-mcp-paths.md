...
Verified: 2026-09-24
Source: [approvals.test.ts](../../../packages/app/server/test/approvals.test.ts), [api.test.ts](../../../packages/app/server/test/api.test.ts), [github.ts](../../../packages/app/server/src/services/github.ts), [mcp.ts](../../../packages/app/server/src/routes/mcp.ts)
